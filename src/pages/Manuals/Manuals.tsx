  ...
  <StyledGlobalPage>
    <div>
      ...
      <Typography variant="body1">
        This book is a tutorial. It aims to help you gradually learn the
        language. But once you’re familiar with the basics, you’ll need other
        resources.
      </Typography>
    </div>
    <div>
      ...
      <Typography variant="body1">
        ...
        browser, then there are other specifications covered in the second part
        of the tutorial.
      </Typography>
    </div>
    <div>
      ...
      <Typography variant="body1">
        The Mozilla Developer Network (MDN) is an excellent JavaScript
        reference. It has both beginner tutorials and comprehensive references.
        The JavaScript section is at{" "}
