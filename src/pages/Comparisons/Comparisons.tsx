...
export const Comparisons = () => (
  <StyledGlobalPage>
    <div>
      ...
      JavaScript makes them, including important peculiarities. At the end
      you’ll find a good recipe to avoid “JavaScript quirks”-related issues.
    </div>
    <div>
      <Typography variant="h4">Boolean is the result</Typography>A comparison
      result is always a boolean. For instance:
      <ul>
        <li>
    ...
    <div>
      ...
      to numbers.
      <IDEEmitter code="" />A value <Highlight>null</Highlight> becomes{" "}
      <Highlight>0</Highlight>, while <Highlight>true</Highlight> becomes{" "}
      ...
      <Highlight>2</Highlight> (conversion happens automatically here). Now, we
      have two numbers, so the comparison is simple and obvious.
      <InfoBox
    ...
    <div>
      <Typography variant="h4">Strict equality</Typography>A regular equality
      check <Highlight>==</Highlight> has a problem. It cannot differentiate 0
      from <Highlight>false</Highlight>:
      <IDEEmitter code="" />
      That’s because <Highlight>false</Highlight> is equivalent to{" "}
      <Highlight>0</Highlight> due to automatic type conversion. For comparisons
      like <Highlight>0 == false</Highlight> JavaScript converts{" "}
      <Highlight>false</Highlight> to <Highlight>0</Highlight>. The strict
      equality operator <Highlight>===</Highlight> checks the equality without
      type conversion.
      <IDEEmitter code="" />
      In this case, the result is <Highlight>false</Highlight> because the types
      are different.
    </div>
    <div>
      ...
      conversion. So <Highlight>null === undefined</Highlight> only if they are
      of the same type.
      ...
      of the comparisons above it must be <Highlight>true</Highlight>, but they
      are both false. The reason is that an equality check{" "}
      <Highlight>==</Highlight> and comparisons{" "}
      <Highlight>{"> < >= <="}</Highlight> work differently. Comparisons convert{" "}
      <Highlight>null</Highlight> to a number, treating it as{" "}
      ...
      defined such that, without any conversions, they equal each other and
      don’t equal anything else. That’s why (2) <Highlight>null == 0</Highlight>{" "}
      is false.
    </div>
    <div>
