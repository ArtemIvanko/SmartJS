  ...
  <StyledGlobalPage>
    <div>
      ...
      <Typography>
        ...
        features were added to the language while old functionality didn’t
        change. That had the benefit of never breaking existing code. But the
        downside was that any mistake or an imperfect decision made by
        JavaScript’s creators got stuck in the language forever. This was the
        case until 2009 when ECMAScript 5 (ES5) appeared. It added new features
        to the language and modified some of the existing ones. To keep the old
        code working, most such modifications are off by default. You need to
        explicitly enable them with a special directive:{" "}
    ...
    <div>
      ...
      <Typography>
        The directive looks like a string: <Highlight>"use strict"</Highlight>{" "}
        or <Highlight>'use strict'</Highlight>. When it is located at the top of
        a script, the whole script works the “modern” way. For example:
      </Typography>
      <IDEEmitter code="" />
    </div>
    <div>
      <Typography>
        ...
        let’s note in advance that <Highlight>"use strict"</Highlight> can be
        put at the beginning of a function. Doing that enables strict mode in
        that function only. But usually people use it for the whole script.
      </Typography>
    </div>
    <div>
      <InfoBox
    ...
    <div>
      ...
      <Typography>
        When you use a developer console to run code, please note that it
        doesn’t <Highlight>use strict</Highlight> by default. Sometimes, when
        use strict makes a difference, you’ll get incorrect results. So, how to
        actually <Highlight>use strict</Highlight>
        in the console? First, you can try to press Shift+Enter to input
        multiple lines, and put use strict on top, like this:
      </Typography>
      <IDEEmitter code="" />
      <Typography>
        It works in most browsers, namely Firefox and Chrome. If it doesn’t,
        e.g. in an old browser, there’s an ugly, but reliable way to ensure{" "}
    ...
    <div>
      ...
      <Typography>
        ...
        what’s cool? Modern JavaScript supports “classes” and “modules” –
        advanced language structures (we’ll surely get to them), that enable{" "}
