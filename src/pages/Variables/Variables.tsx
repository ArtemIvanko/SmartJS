...
export const Variables = () => (
  <StyledGlobalPage>
    ...
    <div>
      <Typography variant="h4">A variable</Typography>A variable is a “named
      ...
      <IDEEmitter code="" />
      To be concise, we can combine the variable declaration and assignment into
      a single line:
      <IDEEmitter code="" />
      We can also declare multiple variables in one line:
      <IDEEmitter code="" />
      That might seem shorter, but we don’t recommend it. For the sake of better
      readability, please use a single line per variable. The multiline variant
      is a bit longer, but easier to read:
      <IDEEmitter code="" />
    ...
    <div>
      ...
      variable <Highlight>message</Highlight> can be imagined as a box labelled{" "}
      <Highlight>"message"</Highlight> with the value{" "}
    ...
    <div>
      We can put any value in the box. We can also change it as many times as we
      want:
      <IDEEmitter code="" />
    ...
    <div>
      ...
      “constants”. They cannot be reassigned. An attempt to do so would cause an
      error:
      <IDEEmitter code="" />
      When a programmer is sure that a variable will never change, they can
      declare it with const to guarantee and communicate that fact to everyone.
    </div>
    <div>
    ...
    <div>
      ...
      When we return to some code after doing something else for a while, it’s
      much easier to find information that is well-labelled. Or, in other words,
      when the variables have good names. Please spend time thinking about the
      right name for a variable before declaring it. Doing so will repay you
      handsomely.
      ...
      <ul>
        ...
        <li>
          Be consistent: if you use <Highlight>userName</Highlight> to store the
          user’s name, don’t use <Highlight>user</Highlight> in another place
          for the same purpose.
        </li>
      </ul>
      Sounds simple? Indeed it is, but creating descriptive and concise variable
      names in practice is not. Go for it.
      <InfoBox
    ...
    <div>
      ...
      <ul>
        ...
        <li>
          The <Highlight>const</Highlight> keyword is used to declare a variable
          that cannot be reassigned.
        </li>
        <li>
          Variables should be named using human-readable names that describe the
          data they store.
        </li>
      </ul>
