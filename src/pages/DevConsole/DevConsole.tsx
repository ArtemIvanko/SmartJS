...
export const DevConsole = () => (
  <StyledGlobalPage>
    <div>
      ...
      Code is prone to errors. You will quite likely make errors… Oh, what am I
      talking about? You are absolutely going to make errors, at least if you’re
      a human, not a robot. But in the browser, users don’t see errors by
      default. So, if something goes wrong in the script, we won’t see what’s
      broken and can’t fix it. To see errors and get a lot of other useful
      information about scripts, “developer tools” have been embedded in
      browsers. Most developers lean towards Chrome or Firefox for development
      because those browsers have the best developer tools. Other browsers also
      provide developer tools, sometimes with special features, but are usually
      playing “catch-up” to Chrome or Firefox. So most developers have a
      “favorite” browser and switch to others if a problem is browser-specific.
      Developer tools are potent; they have many features. To start, we’ll learn
    ...
    <div>
      ...
      <ul>
        ...
        <li>The “Elements” tab shows the HTML of the current page.</li>
        <li>
          The “Sources” tab is for debugging JavaScript. We’ll look at it later.
        </li>
        <li>
        ...
        <li>The “Security” tab is for debugging security issues.</li>
        <li>The “Audits” tab is for running performance audits.</li>
      </ul>
      Below the error message, there is a blue {">"} symbol. It marks a “command
      line” where we can type JavaScript commands. Press Enter to run them. Now
      we can see errors, and that’s enough for a start. We’ll come back to
      developer tools later and cover debugging more in-depth in the chapter
    ...
    <div>
      ...
      select “Inspect Element” from the context menu. Or press F12. The console
      is usually open by default. If not, then you can find it in the “Console”
      tab.
    </div>
    <div>
      <Typography variant="h4">Safari</Typography>
      To open the developer console in Safari, you first need to enable the
      Develop menu. To do that, go to Safari → Preferences → Advanced and check
      “Show Develop menu in menu bar”. After that, you can open the console by
      selecting Develop → Show Error Console.
      <img
    ...
    <div>
      ...
      browser for development is Chrome, but other browsers also have developer
      tools. The exact look of developer tools depends on the browser version,
